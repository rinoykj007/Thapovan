...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Call Us",
      details: ["+91 7588450990", "+91 99233 17808"],
    },
    {
      icon: (
        <svg
    ...
    <div className="min-h-screen bg-white pt-20">
          ...
          >
            ...
            {submitSuccess && (
              <motion.div
                ...
                style={{
                  backgroundColor: "rgba(139, 174, 102, 0.2)",
                  color: "#628141",
                }}
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.button
                ...
                style={{
                  backgroundColor: isSubmitting ? "#a0aec0" : "#E67E22",
                }}
      ...
      <div className="py-20" style={{ backgroundColor: "#f7fafc" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <iframe
              src="https://maps.app.goo.gl/PwwND2crM1i6tBeH6"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen=""
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8" style={{ color: "#EBD5AB" }}>
              Book your visit today and experience the divine blessings that
              await you at Tapovan.
            </p>
            <motion.button
